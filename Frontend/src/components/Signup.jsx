  ...
  return (
    <>
      <div className="flex h-screen items-center justify-center">
        <div id="my_modal_3" className=" border-[1px] shadow-md p-5 rounded-md">
          <div classname="modal-box">
            <form onSubmit={handleSubmit(onSubmit)} method="dialog">
              ...
              <Link to="/" className="btn btn-sm btn-circle btn-ghost absolute right-1/3 top-28">✕</Link>
              <h3 className="font-bold text-lg">Signup</h3>
              <div className="mt-4 space-y-2">
                <span>Name</span>
                <br />
                <input type="text"
                  placeholder="Enter you Fullname" className="w-96 px-3 py-1 border rounded-md outline-none"
              ...
              <div className="mt-4 space-y-2">
                ...
                <br />
                <input type="email"
                  placeholder="Enter you email" className="w-96 px-3 py-1 border rounded-md outline-none"
              ...
              <div className="mt-4 space-y-2">
                ...
                <br />
                <input type="password"
                  placeholder="Enter you password" className="w-96 px-3 py-1 border rounded-md outline-none"
